                ...
                e(".pp_loaderIcon").hide(),
                    ...
                    $pp_pic_holder.animate({
                        ...
                        $pp_pic_holder.find(".pp_hoverContainer,#fullResImage").height(f.height).width(f.width),
                            ...
                            settings.allow_expand && (f.resized ? e("a.pp_expand,a.pp_contract").show() : e("a.pp_expand").hide()), !settings.autoplay_slideshow || P || v || e.prettyPhoto.startSlideshow(),
        ...
        d.prototype = {
            ...
            keydown: function(c) {
                ...
                if (g.options.liveSearch && (e = d.parent().parent()),
                    ...
                    o = g.$menu.parent().hasClass("open"), !o && (c.keyCode >= 48 && c.keyCode <= 57 || event.keyCode >= 65 && event.keyCode <= 90) && (g.options.container ? g.$newElement.trigger("click") : (g.setSize(),
